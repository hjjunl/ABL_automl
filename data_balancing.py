...
if __name__ == '__main__':
    ...
    parser.add_argument('-sampling_strategy', dest= "sampling_strategy", default = 'auto')
    ...
    X_sampling, y_sampling = sampling.sampling_technique(sampling_method=sampling_method, sampling_strategy=sampling_strategy, \

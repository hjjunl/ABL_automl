...
if __name__ == '__main__':
    ...
    parser.add_argument('-sampling_dict', dest= "sampling_dict", default = '{0: 100, 1: 100, 2: 200}')
    ...
    sampling_dict = args.sampling_dict
    ...
    X_sampling, y_sampling = sampling.sampling_technique(sampling_method=sampling_method, sampling_strategy=eval(sampling_dict), \
    ...
    df_sampling.to_pickle(f'{os.getcwd()}/data/preprocessed/train_sampling.pkl')
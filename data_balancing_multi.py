...
if __name__ == '__main__':
    ...
    parser.add_argument('-sampling_ratio', dest= "sampling_ratio", default ='{0: 30, 1: 30, 2: 30}')
    ...
    X_sampling, y_sampling = sampling.sampling_technique(sampling_method=sampling_method, sampling_strategy=eval(sampling_ratio), \
    ...
    if train.split('.')[1] == "csv":
        df_sampling.to_csv(f'{os.getcwd()}/data/{today}/preprocessed/{train}', index=False)

...
class LGBMModel:
    ...
    def train(self, Optuna=None, RandomSearch=None, opt_trials=1, params=None, gpu=False, gpu_id=0, cpu_cnt=1, save_model=False, file_name='LGBMClassifier', random_state=42, cv=5):
        """
        ...
        if not Optuna:
            if not RandomSearch:
                ...
                search = RandomizedSearchCV(lgb_model, params_rs, n_iter=500, scoring='f1_macro', n_jobs=cpu_cnt, cv=cv, random_state=42)
